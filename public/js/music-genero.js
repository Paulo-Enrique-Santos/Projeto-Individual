...
function atualizarMusicas(){
    var nome = document.getElementById(`nome_Genero`);
    nome.innerHTML = sessionStorage.NOME_GENERO;

    var qtdMusica = 0;
    fetch("/atualizar/atualizarMusicasGenero", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
            ...
            idPlaylistServer: sessionStorage.NOME_GENERO
        })
            ...
            resposta.json().then(function (resposta) {
                ...
                for (let i = 0; i < resposta.length; i++) {
                    ...
                    if (verMusica != null) {
                        ...
                        var qtdMusicas = document.getElementById(`qtd_Genero`);
